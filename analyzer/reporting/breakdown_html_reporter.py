"""
Breakdown HTML Report Generator for QAOps Slack Alarm Analyzer.

Generates a report showing alarm occurrences breakdown by day.
"""
import os
...
class BreakdownHtmlReporter:
    """HTML reporter for alarm breakdown by day."""

    def __init__(self):
        """Initialize Breakdown HTML reporter."""
        pass
    ...
    def generate_report(
        ...
        """
        Generate Breakdown HTML report.
        ...
        # Load template
        template = env.get_template('breakdown_report.html')
    ...
    def _get_html_filepath(self, date_range_str: str, products: List[str]) -> str:
        ...
        if products:
            ...
            filename = f"breakdown_report_{products_str}_{safe_date_range}.html"
        else:
            filename = f"breakdown_report_{safe_date_range}.html"
